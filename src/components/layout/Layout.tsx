    ...
    <div className="app-container">
      ...
      <aside className={`app-sidebar ${sidebarOpen ? 'open' : ''} bg-sidebar-bg backdrop-blur-3xl border-r border-border-main transition-all duration-300 z-50`}>
        <div className="p-6 flex items-center justify-between border-b border-border-main">
          ...
          <button className="p-2 lg:hidden text-text-main/60 hover:text-text-main" onClick={toggleSidebar} id="mobile-close-btn">
            <X size={24} />
          </button>
        </div>
        ...
        <div className="p-6 border-t border-white/10">
          <button 
            className="w-full h-12 flex items-center justify-center gap-3 bg-white/5 hover:bg-white/10 text-text-main font-bold rounded-2xl border border-border-main transition-all active:scale-95 group" 
            onClick={toggleTheme}
          >
      ...
      <main className="app-main flex flex-col min-h-screen">
        ...
        <header className="h-20 px-6 flex items-center justify-between bg-sidebar-bg backdrop-blur-md border-b border-border-main sticky top-0 z-40">
          <div className="flex items-center gap-4">
            <button 
              className="lg:hidden p-2 text-text-main/60 hover:text-text-main bg-surface-subtle rounded-xl border border-border-main" 
          ...
          <div className="flex items-center gap-4">
            <div className="px-4 py-2 bg-surface-subtle rounded-full border border-border-main text-xs font-bold shadow-inner">
              <span className="text-text-main/40 uppercase mr-2 tracking-tighter">Semester:</span>
